...
class AuthScaffold extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        ...
        child: SafeArea(  // Added SafeArea to respect notch/status bar
          child: Center(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      // Back Button (only shown if can pop)
                      IconButton(
                  ...
                  _inputField(Icons.lock_outline, "Password", isDark, obscure: true),
                  const SizedBox(height: 22),
                  SizedBox(
  ...
  Widget _inputField(IconData icon, String hint, bool isDark, {bool obscure = false}) {
    return TextField(
      obscureText: obscure,
